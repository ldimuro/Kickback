...
class AppDelegate: UIResponder, UIApplicationDelegate, SPTSessionManagerDelegate, SPTAppRemoteDelegate, SPTAppRemotePlayerStateDelegate {
    ...
    lazy var sessionManager: SPTSessionManager = {
        if let tokenSwapURL = URL(string: "https://sweet-green.glitch.me/api/token"),
            let tokenRefreshURL = URL(string: "https://sweet-green.glitch.me/api/refresh_token") {
...
//        UserDefaults.standard.set(userLoginStatus, forKey: "isUserLoggedIn")
...
//        UserDataArray.friends.removeAll()
        ...
        if(userLoginStatus)
        {
            ...
            //INITIATE SPOTIFY SESSION
            let requestedScopes: SPTScope = [.appRemoteControl, .userReadPlaybackState, .playlistReadPrivate, .playlistReadCollaborative]
            self.sessionManager.initiateSession(with: requestedScopes, options: .default)
            print("SPOTIFY INITIATED")
